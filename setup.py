...
short_description = "Integration of CodeEntropy tool with the POSEIDON code to form a complete and generally applicable set of tools for calculating entropy".split("\n")[0]
